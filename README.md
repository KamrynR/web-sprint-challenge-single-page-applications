...
Easier for accessing match data.
1. How would you explain form validation to someone who has never programmed before?
It basically has the user require legitimate data, before proceeding.
1. In 1-2 sentences, define end to end testing.
It tests what the user would encounter throughout the whole project./
